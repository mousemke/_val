...
class DND extends Module
{
        ...
        return {
            commands : {
                ...
                listCharacters : {
                    ...
                    desc    : 'lists all characters in the channel and their corresponding player',
                    syntax  : [
                        `${trigger}listCharacters`,
                    ]
                },
    ...
    saveCharacterList()
    {
        ...
        fs.writeFileSync( `./json/characters/characters.${botName}.json`, charactersJSON, 'utf8' );
    }
